...
txt4 = """
The Bengal tiger is a population of the Panthera tigris  subspecies It ranks among the biggest wild cats alive today. It is considered to belong to the world's charismatic megafauna
...
pdf.set_font(family="Times",size=23, style="B")
pdf.cell(w=100, h=20, txt="Species", ln=1)

pdf.set_font(family="Times",size=23, style="B")
pdf.cell(w=100, h=20, txt="Panthera tigris", ln=1)
